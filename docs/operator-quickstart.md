# Operator Quickstart — cloud-itonami-isic-862

Shortest path from clone to a verified local dry-run for **ISIC 862** (`cloud-itonami-isic-862`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-862.git
cd cloud-itonami-isic-862
```
...
- Likely source path: `clinicops.governor.cljc`
